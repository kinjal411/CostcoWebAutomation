 ...
 * @author kinjal patel
 */
public class CostcoTravelTest {
    
    private WebDriver driver;
    private String baseUrl;
   
    public CostcoTravelTest() {
    }
...
//    WebDriverWait wait=new WebDriverWait(driver, 30);  //20 sec to wait before clicking  (only change accordinglly
//    wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath("//[contains(text(), 'Vacation Packages')]")));  // "uname" (only change accordingally)
...
//    elem2.click();
   ...
   // driver.findElement(By.xpath("//[contains(text(), 'Vacation Packages')]"));
